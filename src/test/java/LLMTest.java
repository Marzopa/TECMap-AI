...
public class LLMTest {
    ...
    public void testLLM() throws IOException, InterruptedException {
        ...
        AssessmentRecord assessmentRecord = new AssessmentRecord(gradingResponse.grade(), "screw everyone", "studentId", gradingResponse.feedback());
    ...
    public void testSubmitResponse() throws IOException, InterruptedException {
        ...
        AssessmentRecord assessmentRecord = new AssessmentRecord(gradingResponse.grade(), "for(int i=1; i<=10) System.out.println(i);", "tweaky256", gradingResponse.feedback());
        learningMaterial.getAssessmentItem().submitSolution(assessmentRecord);
        ...
        AssessmentRecord assessmentRecord2 = new AssessmentRecord(gradingResponse2.grade(), "for(int i=1; i<=10; i++) System.out.println(i);", "oscar123", gradingResponse2.feedback());
